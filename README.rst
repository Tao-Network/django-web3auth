...
.. image:: https://badge.fury.io/py/django-web3auth.svg
    :target: https://badge.fury.io/py/django-web3auth

.. image:: https://travis-ci.org/Tao-Network/django-web3auth.svg?branch=master
    :target: https://travis-ci.org/Tao-Network/django-web3auth

.. image:: https://codecov.io/gh/Tao-Network/django-web3auth/branch/master/graph/badge.svg
    :target: https://codecov.io/gh/Tao-Network/django-web3auth

django-web3auth is a pluggable Django app that enables login/signup via an Ethereum wallet (a la CryptoKitties). The user authenticates themselves by digitally signing the session key with their wallet's private key.

.. image:: https://github.com/Tao-Network/django-web3auth/blob/master/docs/_static/web3_auth_test.gif?raw=true

Documentation
-------------

The full documentation is at https://django-web3auth.readthedocs.io.

Note
-------------

The original repo seemed abandoned and hadn't been updated in years. Some requirements were out of date. You can find the original repo at https://github.com/Bearle/django-web3-auth/


Example project
---------------

https://github.com/Tao-Network/django-web3auth/tree/master/example
...
Quickstart
----------
Install Django-web3auth with pip::

    pip install django-web3auth
...
Add Django-web3auth's URL patterns:
...
If you have any questions left, head to the example app https://github.com/Tao-Network/django-web3auth/tree/master/example
